...
\[x_i \in N\]
\[E(X) = \sum_{i=1}^{\infty} i \cdot Pr(X=i) = \frac{1}{6} \cdot \sum_{i=1}^{\infty} i \cdot (\frac{5}{6})^{i-1} \]
...
\begin{wrapfigure}[2]{l}{0.4\linewidth}
\vspace{-40pt}
...
\[T(n) = n + \frac{2}{n} \sum_{i=1}^n T(i-1) \]
\[ \Leftrightarrow T(n) = n + \frac{2}{n} \sum_{i=0}^{n-1} T(i) \]
...
\[ \Leftrightarrow T(n) \leq \frac{n+1}{n} T(n-1) + 2 \leq \frac{n+1}{2} (\frac{n}{n+1} \cdot T(n-2) + 2) + 2 \]
\[ = \frac{n+1}{n-1} T(n-2) + \frac{n+1}{n} \cdot 2 + 2\]
\[ \leq \frac{n+1}{n-1} (\frac{n-1}{n-2} T(n-3) +2 ) + \frac{n+1}{n} \cdot 2 + 2 \cdot 1\]
