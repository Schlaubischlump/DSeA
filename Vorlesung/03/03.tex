...
\lstinputlisting[language=C]{03/Code/mergesort.c}
...
\begin{flalign*}
&T(n) = 2 \cdot 2 T \left(\frac{n}{2} \right) + n \stackrel{\text{(1)}}{=} 2 \left( 2 T \left(\frac{n}{4} + \frac{n}{2}\right) + n \right) = 4 T\left(\frac{n}{4} \right) + 2n&\\
